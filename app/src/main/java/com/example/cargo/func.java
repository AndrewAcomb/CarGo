...
public class Main {
    ...
    private static AuthClient func_client;
    ...
    public static void main(String[] args) {
        ...
        public static AuthClient getAuthClient(){return client};
        func_client = getAuthClient();

    }
    public static String getCarAccess(){
        return access;
    }

    public static AuthClient giveAuth(){return func_client;}
